...
# SMTP Configuration
SMTP_SSL_WEB_URL = ""  # Add your SMTP server URL
SMTP_SSL_PORT = 
SMTP_SSL_LOGIN_ID = ""  # Add your login ID
SMTP_SSL_LOGIN_PASSWORD = ""  # Add your login password
SMTP_SENDER_EMAIL = ""  # Add your sender email
SMTP_MAIL_PASSWORD = ""  # Add your mail password
RECIPIENTS_EMAIL = "",",""  # Add the recipient email
